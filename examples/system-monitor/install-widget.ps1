# Install System Monitor Widget to Widget Container
...
$widgetsPath = "$userDataPath\widgets\system-monitor-widget"

Write-Host "Installing System Monitor Widget..." -ForegroundColor Cyan
...
Write-Host ""
Write-Host "System Monitor Widget installed successfully!" -ForegroundColor Green
